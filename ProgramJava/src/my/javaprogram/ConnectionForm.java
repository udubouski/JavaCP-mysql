...
import static my.javaprogram.WorkForm.infoBox;
...
public class ConnectionForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String database = jTextField2.getText();
            String userlogin = jTextField3.getText();
            String password = String.valueOf(jPasswordField1.getPassword());
            
            WorkForm win = new WorkForm(host,database,userlogin,password);
            win.setLocationRelativeTo(null);
            infoBox("OK!","InfoMessage");
            win.setVisible(true);
            this.dispose();
        } catch (Exception ex) {
            infoBox("Error! Check entered data!","Alert");
            ex.printStackTrace();
        }
